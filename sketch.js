...
function setup() 
{
  ...
  airBlower = createImg('balloon2.png');
  ...
  unmute_btn.position(width-60,10);
  unmute_btn.size(65,65);
  unmute_btn.hide();
...
{
  if(counter!==1){
    alert("Hey you forgot to collect your star here!!")
